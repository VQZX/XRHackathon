...
public class ApiAiModule : MonoBehaviour
{
    ...
    public static event Action<string> ResponseRecieved;
    public static event Action ErrorRecieved;
    ...
    IEnumerator Start()
    {
        ...
        const string ACCESS_TOKEN = "9bc8eb93725841de8cedd154f2de8d41";
